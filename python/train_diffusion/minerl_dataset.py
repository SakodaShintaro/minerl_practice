...
def action_tensor_to_dict(action_tensor: torch.Tensor) -> dict:
    ...
    return {
        ...
        "attack": int(action_tensor[2].item()),
        "back": int(action_tensor[3].item()),
        "drop": int(action_tensor[4].item()),
        "forward": int(action_tensor[5].item()),
        "hotbar.1": int(action_tensor[6].item()),
        "hotbar.2": int(action_tensor[7].item()),
        "hotbar.3": int(action_tensor[8].item()),
        "hotbar.4": int(action_tensor[9].item()),
        "hotbar.5": int(action_tensor[10].item()),
        "hotbar.6": int(action_tensor[11].item()),
        "hotbar.7": int(action_tensor[12].item()),
        "hotbar.8": int(action_tensor[13].item()),
        "hotbar.9": int(action_tensor[14].item()),
        "inventory": int(action_tensor[15].item()),
        "jump": int(action_tensor[16].item()),
        "left": int(action_tensor[17].item()),
        "pickItem": int(action_tensor[18].item()),
        "right": int(action_tensor[19].item()),
        "sneak": int(action_tensor[20].item()),
        "sprint": int(action_tensor[21].item()),
        "swapHands": int(action_tensor[22].item()),
        "use": int(action_tensor[23].item()),
    }
